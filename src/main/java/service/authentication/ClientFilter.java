...
public class ClientFilter implements Filter {
    final static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(ClientFilter.class);
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        logger.info("In The Client Filter");
...
//        }
        ...
        try {
            ...
            if(!Objects.equals(tokenBody.getSubject(), "Client"))
                response.getWriter().write("!!!You cannot see this page!!!");
            else
